...
\begin{problem}
  ...
  Experiment adding very small numbers to the number 1.0 until you see no change.
  That is, what is the smallest $\delta$ such that \emph{on the computer} $1+\delta>1$?
  Is your answer for \code{float} or \code{double}?

  \subpart Now what is the smallest $\delta$ such that \emph{on the computer} $\sqrt{1 + \delta}>1$?
\end{problem}
...
\begin{problem}
  ...
  \begin{align}
    f(\theta,\alpha) &= sin(3\,\theta)\,\sin(5,\varpi) ~.
  \end{align}
  ...
  Overplot thin or faint vertical and horizontal lines showing where you expect to see maxima and minima of this function.
  ...
  Do you feel better about your plot now? Or not?
\end{problem}
