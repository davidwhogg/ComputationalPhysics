...
\begin{problem}
  ...
  \subpart What is the largest $\Delta$ such that $\exp(-\Delta)>0$? What about such that $\exp(\Delta)$ gives a floating-point answer?
\end{problem}
...
\begin{note}
  ...
  Think hard aobout this and choose wisely!
